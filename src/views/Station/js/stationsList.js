    ...
    methods: {
        ...
        onProvinceChange(picker, values) {
            if (values[0]) {
                ...
                console.log('provinceObj:', this.provinceObj);
            }
        },
        ...
        itemClick(item, index) {
            ...
            window.location.href = 'http://mgo.18jian.cn/dist/views/Station/stationDetails.html';
        },
        cancleClick() {
